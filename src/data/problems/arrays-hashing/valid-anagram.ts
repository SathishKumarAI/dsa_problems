  ...
  alternatives: [
    {
      ...
      costWhy:
        "Two sorts dominate: each is O(n log n), and at the ceiling of 5\u00b710\u2074 that is roughly 1.6\u00b710\u2076 comparisons across both. The comparison afterwards is one linear scan and disappears into the sort. The O(n) space is not optional in any of the three languages here \u2014 Python\u2019s sorted() builds a new list, and Java and C++ sort a COPY of the characters, because sorting the argument in place would mutate the caller\u2019s string. Worth knowing the shape of the win it gives up: this rung answers a question about counts by first rebuilding both strings in a canonical order, which is strictly more information than the question needs.",
      python: `def is_anagram(s: str, t: str) -> bool:
