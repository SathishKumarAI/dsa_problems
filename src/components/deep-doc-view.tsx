// The reader for one long-form teaching document (`docs/deep/<id>_explained.md`).
//
// Route: `#/deep/<problem-id>`. The document is fetched on arrival, never with
...
import { loadDeepDoc } from "@/lib/deep-docs"
...
export function DeepDocView({ id }: { id: string }) {
    ...
    return (
      <div className="mx-auto flex max-w-(--container-reading) flex-col gap-4">
        ...
        <p className="text-body text-muted-foreground">
          No deep document for <code className="font-mono">{id}</code> yet. The
