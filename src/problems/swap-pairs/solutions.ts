// swap-pairs — the ladder: every way in, worst first.
//
...
export const java = `public ListNode swapPairs(ListNode head) {
...
export const cpp = `ListNode* swapPairs(ListNode* head) {
    ListNode* dummy = new ListNode(0, head);
    ListNode* prev = dummy;
