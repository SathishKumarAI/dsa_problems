// merge-two-sorted — the teaching document, assembled from the files beside it.
//
...
import { approach as collectRung } from "./approaches/collect.ts"
...
export const doc: TeachingDoc = {
  ...
  understanding,
  unlocks,
  approaches: [collectRung, recurseRung, dummyRung],
  arc,
  comparison,
  interview,
  scriptNote,
