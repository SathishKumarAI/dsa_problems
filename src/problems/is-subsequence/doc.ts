// is-subsequence — the teaching document, as data.
//
// Converted from docs/deep/is-subsequence_explained.md by
...
export const doc: TeachingDoc = {
  ...
  understanding: `Take a long sentence and a marker pen, and black out any letters you like. Whatever survives, read
...
---`,
  ...
  arc: `The principle this problem chases is *never re-derive a position you already had*. The definition
...
---`,
  ...
  interview: `> **In an interview.** Say the exchange argument **before** the code, unprompted: *"taking the
...
---`,
  scriptNote: `Both approaches in one file, checked against the statement's two examples, the smallest legal
...
neither approach mutates its arguments.`,
  script: `"""Is One String Hidden in the Other? - every approach in one file, cross-checked.
