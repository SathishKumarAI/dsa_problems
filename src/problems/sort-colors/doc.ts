// sort-colors — the teaching document, assembled from the files beside it.
//
...
import { approach as countRung } from "./approaches/count.ts"
import { approach as pointersRung } from "./approaches/pointers.ts"
...
export const doc: TeachingDoc = {
  ...
  understanding,
  approaches: [countRung, pointersRung],
  arc,
  comparison,
  interview,
  scriptNote,
