// rotate-array — the teaching document, assembled from the files beside it.
//
...
import { approach as oneStepAtATimeRung } from "./approaches/one-step-at-a-time.ts"
import { approach as copyIntoASecondArrayRung } from "./approaches/copy-into-a-second-array.ts"
import { approach as cutAndRejoinRung } from "./approaches/cut-and-rejoin.ts"
import { approach as cyclicReplacementsRung } from "./approaches/cyclic-replacements.ts"
...
export const doc: TeachingDoc = {
  ...
  understanding,
  unlocks,
  approaches: [oneStepAtATimeRung, copyIntoASecondArrayRung, cutAndRejoinRung, cyclicReplacementsRung, optimalRung],
  arc,
  comparison,
  interview,
  scriptNote,
