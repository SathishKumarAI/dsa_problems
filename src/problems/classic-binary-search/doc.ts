// classic-binary-search — the teaching document, assembled from the files beside it.
//
...
import { approach as loopRung } from "./approaches/loop.ts"
import { approach as convergeRung } from "./approaches/converge.ts"
import { arc, comparison } from "./arc.ts"
import { interview } from "./interview.ts"
import { scriptNote, script } from "./script.ts"

export const doc: TeachingDoc = {
  problemId: "classic-binary-search",
  understanding,
  unlocks,
  approaches: [scanRung, recurseRung, loopRung, convergeRung],
  arc,
  comparison,
  interview,
  scriptNote,
