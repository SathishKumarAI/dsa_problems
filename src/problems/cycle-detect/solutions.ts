// cycle-detect — the ladder: every way in, worst first.
//
...
export const java = `public boolean hasCycle(ListNode head) {
    ListNode slow = head;
    ListNode fast = head;
...
export const cpp = `bool hasCycle(ListNode* head) {
    ListNode* slow = head;
    ListNode* fast = head;
