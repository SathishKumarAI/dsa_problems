// largest-rectangle — the teaching document, assembled from the files beside it.
//
...
import { approach as expandRung } from "./approaches/expand.ts"
import { approach as divideRung } from "./approaches/divide.ts"
...
export const doc: TeachingDoc = {
  ...
  understanding,
  unlocks,
  approaches: [expandRung, divideRung, stackRung],
  arc,
  comparison,
  interview,
  scriptNote,
