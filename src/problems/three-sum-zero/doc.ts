// three-sum-zero — the teaching document, assembled from the files beside it.
//
...
import { approach as twoptrRung } from "./approaches/twoptr.ts"
...
export const doc: TeachingDoc = {
  ...
  understanding,
  calculations,
  approaches: [bruteRung, hashRung, twoptrRung],
  arc,
  comparison,
  interview,
  fluent,
