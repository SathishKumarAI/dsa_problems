// three-sum-zero — the ladder: every way in, worst first.
//
...
export const java = `public List<List<Integer>> threeSum(int[] nums) {
    Arrays.sort(nums);
...
export const cpp = `vector<vector<int>> threeSum(vector<int> nums) {
