// daily-warmer — the teaching document, assembled from the files beside it.
//
...
import { approach as backwardRung } from "./approaches/backward.ts"
...
export const doc: TeachingDoc = {
  ...
  understanding,
  unlocks,
  approaches: [bruteRung, backwardRung, stackRung],
  arc,
  comparison,
  interview,
  scriptNote,
