// move-zeroes — the teaching document, assembled from the files beside it.
//
...
import { approach as swapRung } from "./approaches/swap.ts"
...
export const doc: TeachingDoc = {
  ...
  understanding,
  approaches: [copyRung, readwriteRung, swapRung],
  arc,
  comparison,
  interview,
  scriptNote,
