...
export const TECHNIQUE_TERMS: Term[] = [
  {
    ...
    reading: [
      {
        title: "Sedgewick & Wayne, Algorithms 4",
        url: "https://algs4.cs.princeton.edu/home/",
        note: "the partitioning and merging code these walks generalise",
      },
    ],
    source:
      "Xu & Gunawardane, Coding Interview Patterns (2024), ch. two pointers",
  },
  {
    slug: "sliding-window",
    term: "sliding window",
    ...
    source:
      "Xu & Gunawardane, Coding Interview Patterns (2024), ch. sliding windows",
  },
  {
    slug: "prefix-sum",
    term: "prefix sum",
  ...
  },
  {
    ...
    reading: [
      ...
      },
      {
        ...
        note: "Bloch on the overflow bug, in the JDK, found after nine years",
      },
    ],
  },
  {
    ...
    costs: [
      { op: "visit every node and edge", bound: "O(V + E)" },
      {
        ...
        bound: "O(V)",
        unless:
          "the recursion depth is the height, which on a balanced tree is O(log V)",
      },
    ],
    ...
    reading: [
      {
        title: "Depth-first search (Wikipedia)",
  ...
  },
  {
    ...
    costs: [
      { op: "visit every node and edge", bound: "O(V + E)" },
      {
        ...
        bound: "O(V)",
        unless:
          "the frontier can be the whole width of the graph, which on a grid is O(min(rows, cols))",
      },
    ],
    ...
    costs: [
      {
        op: "subsets of n",
        bound: "O(2ⁿ · n)",
        unless: "the n is copying each subset out",
      },
  ...
  },
  {
    ...
    reading: [
      ...
      {
        title: "functools.cache / lru_cache",
    ...
    costs: [
      {
        ...
        bound: "O(V + E)",
        unless:
          "there is a cycle, in which case there is no ordering at all and the algorithm's job is to say so",
      },
    ],
