...
export const COMPLEXITY_TERMS: Term[] = [
  {
    ...
    reading: [
      ...
      },
      {
        ...
        note: "the per-operation table the bounds on this site are counted from",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    costs: [
      {
        op: "comparison sort, lower bound",
        bound: "O(n log n)",
        unless:
          "you are not comparing — counting sort and radix sort beat it by using the keys' structure",
      },
    ...
    reading: [
      {
        title: "Sorting algorithm: stability (Wikipedia)",
      ...
      },
      {
        ...
        note: "Tim Peters' own description of the run-detection that makes it O(n) on ordered data",
      },
    ],
  },
  {
    ...
    reading: [
      ...
      },
      {
        ...
        note: "the L1-vs-RAM gap, by year, which is the whole argument",
      },
    ],
  },
]
