...
| B32 | ☐ **The visualization cookbook** — a Python-first guide to building algorithm and LLM visualisations: how this repo's frame/act model works, how to reproduce it in Python (matplotlib/manim/rich), and how to visualise tokenisation, attention and sampling using EXISTING open tools (bertviz, tiktoken, transformer-lens, Netron, manim) rather than rebuilding them. Requested 2026-09-07. Draft: `docs/VISUALIZING.md`. | The learner asked to understand how the visualisations are made, not just to watch them — and asked explicitly to reuse open-source projects rather than start from scratch. | L | — |
