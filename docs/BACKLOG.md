...
| R8 | ☐ **Step-completion feedback** — a brief flat colour change on a step chip the moment it is marked done, before it settles into its locked/done state. | An act ends with no moment of closure; the chip just is green next time you look. | XS | P2 |
