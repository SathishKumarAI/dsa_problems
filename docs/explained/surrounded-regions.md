# Capture the Enclosed Regions — Explained, One Approach at a Time

<!-- Generated by scripts/gen-explained.mjs from src/data/problems/graphs/surrounded-regions.ts.
...
## 1. Fill each region and check afterwards
