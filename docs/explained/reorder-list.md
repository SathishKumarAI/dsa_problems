# Fold the List Onto Itself — Explained, One Approach at a Time

<!-- Generated by scripts/gen-explained.mjs from src/data/problems/linked-list/reorder-list.ts.
...
## 1. Recursive fold from the ends
...
## 2. Walk from the head for every position
...
## 3. Copy the values, write them back
