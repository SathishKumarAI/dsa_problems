# Rotate the List to the Right by k — Explained, One Approach at a Time

<!-- Generated by scripts/gen-explained.mjs from src/data/problems/linked-list/rotate-list.ts.
...
## 2. Values into an array, rebuild rotated
...
## 4. Measure, then walk to the cut
