# Read a Tree Left, Node, Right — Explained, One Approach at a Time

<!-- Generated by scripts/gen-explained.mjs from src/data/problems/trees/inorder-walk.ts.
...
## 1. Rebuild the answer at every node
