# The Smallest Ship That Still Makes the Deadline — Explained, One Approach at a Time

<!-- Generated by scripts/gen-explained.mjs from src/data/problems/binary-search/ship-in-d-days.ts.
...
## 2. Binary search over every capacity from 1
