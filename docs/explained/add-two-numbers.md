# Add the Digits, Least Significant First — Explained, One Approach at a Time

<!-- Generated by scripts/gen-explained.mjs from src/data/problems/linked-list/add-two-numbers.ts.
...
## 1. Turn both lists into numbers
