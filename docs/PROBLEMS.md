...
Ordered by **how much of the stage already exists**: chips, sorted chips, sum equation, hash map,
bit rows, bars (visualizer) and the code challenge harness are built. A row that needs a new panel
