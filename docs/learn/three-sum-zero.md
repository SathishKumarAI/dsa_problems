...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/two-pointers/three-sum-zero.ts
     and docs/deep/three-sum-zero_explained.md.
...
> Three sum is two sum with a loop around it, and the ladder is mostly about DUPLICATES rather than speed.
