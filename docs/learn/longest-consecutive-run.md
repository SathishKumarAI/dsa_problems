...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/arrays-hashing/longest-consecutive-run.ts
     and docs/deep/longest-consecutive-run_explained.md.
...
> Sorting is the obvious way to make neighbours adjacent, and it is also the thing to question: the answer needs to know which values EXIST, not what order they come in.
