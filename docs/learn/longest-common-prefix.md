# Prefix Shared by Every String

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/arrays-hashing/longest-common-prefix.ts
     and docs/deep/longest-common-prefix_explained.md.
...
## Rung 1 — Shrink against each string
...
> Two ways to slice the same work: compare strings against a shrinking candidate, or compare column by column across all strings and stop at the first disagreement.
