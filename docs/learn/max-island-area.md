...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/graphs/max-island-area.ts
...
[Count the Islands](island-count.md) · [Course Ordering (Topological Sort)](course-order.md) · [Rotting Spread (Multi-source BFS)](rotting-fruit.md) · [Trace a Word Through the Grid](word-search.md) · [How Many Connected Groups?](count-provinces.md) · [When Does the Signal Reach Everyone?](network-delay.md) · [Capture the Enclosed Regions](surrounded-regions.md) · [Repaint the Patch You Clicked](flood-fill.md) · [Rain That Reaches Both Oceans](pacific-atlantic.md) · [Fewest Cells Across an Open Grid](shortest-path-grid.md)
