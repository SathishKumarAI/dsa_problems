# The Triple Nearest the Target

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/two-pointers/three-sum-closest.ts
     and docs/deep/three-sum-closest_explained.md.
...
## Rung 3 — Binary search the third
