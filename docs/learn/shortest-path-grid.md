# Fewest Cells Across an Open Grid

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/graphs/shortest-path-grid.ts
...
## Rung 3 — Breadth-first, marked on the way out
