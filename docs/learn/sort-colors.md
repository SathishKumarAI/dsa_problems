# Sort Three Colours In Place

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/two-pointers/sort-colors.ts
     and docs/deep/sort-colors_explained.md.
...
> Counting and rewriting is two passes and completely fine; the reason the one-pass version is famous is the invariant, not the speed.
