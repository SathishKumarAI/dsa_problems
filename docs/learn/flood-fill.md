# Repaint the Patch You Clicked

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/graphs/flood-fill.ts
...
## Rung 1 — Sweep the whole grid until nothing changes
...
## Rung 2 — A queue from the start pixel
