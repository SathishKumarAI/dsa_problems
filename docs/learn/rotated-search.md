...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/binary-search/rotated-search.ts
     and docs/deep/rotated-search_explained.md.
...
> One probe, three questions: which half is sorted, is the target inside that sorted half, and therefore which half to discard.
