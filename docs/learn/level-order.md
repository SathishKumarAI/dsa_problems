...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/trees/level-order.ts
     and docs/deep/level-order_explained.md.
...
> Both rungs produce the same nested lists, and the difference is whether the grouping is a property of the walk or a lucky by-product of it.
