# Rain That Reaches Both Oceans

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/graphs/pacific-atlantic.ts
...
## Rung 1 — A search downhill from every cell
...
## Rung 2 — The same search, stopped early
