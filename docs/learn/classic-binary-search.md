...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/binary-search/classic-binary-search.ts
     and docs/deep/classic-binary-search_explained.md.
...
> The base case of a whole pattern, and worth writing until the boundaries are automatic: while low is at most high, probe the middle, and move the side that cannot contain the answer.
