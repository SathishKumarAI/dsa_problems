# Two Strings After the Backspaces

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/two-pointers/backspace-compare.ts
     and docs/deep/backspace-compare_explained.md.
...
## Rung 1 — Recursion, one cancel at a time
...
## Rung 2 — Rebuild the text by slicing
...
## Rung 4 — Backward pass with a skip counter
...
> Reading forwards means a character's fate is decided by things that have not happened yet, which is why the stack rung exists — it undoes work it already did.
