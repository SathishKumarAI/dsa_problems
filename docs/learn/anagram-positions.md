# Where Every Anagram Hides

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/sliding-window/anagram-positions.ts
     and docs/deep/anagram-positions_explained.md.
...
## Rung 2 — Count every window from scratch
...
## Rung 3 — Slide the tally, compare all 26
...
> Anagram means multiset, and multiset means counts — once that substitution is made, every rung is an argument about how much of the counting to redo.
