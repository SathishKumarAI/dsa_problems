...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/linked-list/cycle-detect.ts
     and docs/deep/cycle-detect_explained.md.
...
> Both rungs answer one question — has this walk been here before — and they differ only in what they are willing to store.
