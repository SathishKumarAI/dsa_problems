...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/arrays-hashing/pair-sum.ts
     and docs/deep/pair-sum_explained.md.
...
> Every step follows one idea applied twice: do not redo work you do not need to.
