...
<!-- Generated by scripts/gen-learn.mjs from src/data/problems/arrays-hashing/rotate-array.ts
     and docs/deep/rotate-array_explained.md.
...
## Rung 2 — Copy into a second array
...
> Three genuinely different ideas share this ladder: copy into place using modular arithmetic, follow the cycles of the rotation permutation, or reverse three times.
