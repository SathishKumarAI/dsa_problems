# What Both Arrays Hold

<!-- Generated by scripts/gen-learn.mjs from src/data/problems/arrays-hashing/intersection-of-arrays.ts
     and docs/deep/intersection-of-arrays_explained.md.
...
## Rung 1 — Cross off with used flags
...
## Rung 2 — Sort both, then two cursors
...
## Rung 3 — Count both sides, take the minimum
...
## Rung 4 — One count table, spend as you go
...
> The ladder is a tour of every way two collections can be compared: cross off in place, sort both and walk cursors, count both sides and take the minimum per value, or count the smaller side and spend from it while scanning the larger.
